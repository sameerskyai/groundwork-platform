  ...
  if (!/^\d{5}$/.test(zip)) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-[var(--color-ink-2)]">Invalid ZIP code.</p>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-[var(--color-base-alt)]">
      ...
      <div className="max-w-2xl mx-auto px-6 py-10">
        ...
        <div className="mb-8">
          ...
          {!belowThreshold && (
            <p className="text-[var(--color-ink-2)] mt-1 text-sm">
        ...
        {belowThreshold ? (
          <div className="bg-[var(--color-base)] rounded-2xl border border-[var(--color-line)] p-10 text-center mb-8">
            <div className="text-4xl mb-4">🏗️</div>
            <h2 className="text-lg font-bold text-[var(--color-ink)] mb-2">Laywork is just getting started here</h2>
            <p className="text-[var(--color-ink-2)] text-sm mb-6">
        ...
        <div className="bg-[var(--color-base)] rounded-2xl border border-[var(--color-line)] p-6 text-center">
          <h2 className="font-bold text-[var(--color-ink)] mb-2">Get an estimate for your project</h2>

        ...
        <div className="rounded-2xl p-6 border" style={{ background: 'var(--color-surface-secondary)', borderColor: 'var(--color-border-strong)' }}>
          {sent ? (
            <p className="text-sm leading-relaxed" style={{ color: 'var(--color-ink-2)' }}>
              If an account exists for <span style={{ color: 'var(--color-ink)' }}>{email}</span>, a password
            ...
            <form onSubmit={handleReset} className="flex flex-col gap-4">
              <div>
                <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--color-ink-2)' }}>Email</label>
                <input
                  type="email"
                  value={email}

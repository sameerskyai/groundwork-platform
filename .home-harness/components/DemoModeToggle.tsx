  ...
  return (
    <button
      ...
      style={{
        ...
        backgroundColor: isDemoMode ? 'color-mix(in srgb, var(--color-accent) 12%, transparent)' : 'transparent',
        borderColor: isDemoMode ? 'var(--color-accent)' : 'var(--color-line)',
        color: isDemoMode ? 'var(--color-accent)' : 'var(--color-ink-2)'
      }}

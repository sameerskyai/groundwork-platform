  ...
  return (
    <div style={{ background: 'var(--color-base-alt)', minHeight: '100vh' }}>
      ...
      <main style={{ maxWidth: 740, margin: '0 auto', padding: '80px 24px' }}>
        ...
        <h1 style={{ color: 'var(--color-ink)', fontSize: 44, fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1.08, marginBottom: 40 }}>
          Why we built this.
        </h1>

        <div style={{ display: 'flex', flexDirection: 'column', gap: 24, color: 'var(--color-ink)', fontSize: 17, lineHeight: 1.85 }}>
          <p>
          ...
          <div style={{ borderLeft: '3px solid var(--color-accent)', paddingLeft: 24, margin: '8px 0', fontStyle: 'italic', color: 'var(--color-ink)', fontSize: 19, fontWeight: 500, lineHeight: 1.7 }}>
        ...
        <div style={{ marginTop: 60, padding: '32px', background: 'var(--color-ink)', borderRadius: 20 }}>
          <h2 style={{ color: 'var(--color-base)', fontSize: 22, fontWeight: 800, marginBottom: 16 }}>Say hello</h2>
          <p style={{ color: 'var(--color-line)', fontSize: 15, lineHeight: 1.7, marginBottom: 20 }}>
          ...
          <a href="mailto:hello@groundworkapp.com" style={{ color: 'var(--color-brand-light)', fontSize: 15, fontWeight: 600, textDecoration: 'none' }}>

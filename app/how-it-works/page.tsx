    ...
    <div style={{ background: 'var(--color-base-alt)', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'var(--color-ink)', padding: '80px 24px', textAlign: 'center' }}>
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          <h1 style={{ color: 'var(--color-base)', fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: 800, lineHeight: 1.1, letterSpacing: '-0.03em', marginBottom: 16 }}>
            How Laywork works
          </h1>
          <p style={{ color: 'var(--color-line)', fontSize: 17, lineHeight: 1.7 }}>
      ...
      <section style={{ padding: '90px 24px', background: 'var(--color-base-alt)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 60, alignItems: 'center' }}>
          <div>
            <div style={{ fontFamily: 'monospace', fontSize: '6rem', fontWeight: 700, color: 'var(--color-line)', lineHeight: 1, marginBottom: 12 }}>01</div>
            <h2 style={{ color: 'var(--color-ink)', fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 16 }}>
              Describe your project
            </h2>
            <p style={{ color: 'var(--color-text-muted)', fontSize: 16, lineHeight: 1.8, marginBottom: 20 }}>
          ...
          <div style={{ background: 'var(--color-base)', borderRadius: 16, padding: '28px', border: '1px solid var(--color-line)' }}>
            <div style={{ background: 'var(--color-base-alt)', borderRadius: 12, padding: '20px', marginBottom: 16 }}>
              <div style={{ color: 'var(--color-text-muted)', fontSize: 12, fontWeight: 600, marginBottom: 8 }}>Your description</div>
              <p style={{ color: 'var(--color-ink)', fontSize: 14, lineHeight: 1.7 }}>&ldquo;I need my kitchen renovated. It&apos;s a galley kitchen from the 1960s that I want to open up into the dining room. New cabinets, countertops, and appliances.&rdquo;</p>
            </div>
            <div style={{ background: 'var(--color-brand-lighter)', border: '1px solid var(--color-line)', borderRadius: 12, padding: '16px' }}>
              <div style={{ color: 'var(--color-accent)', fontSize: 12, fontWeight: 600, marginBottom: 8 }}>AI follow-up questions</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                {['What\'s the approximate square footage of the kitchen?', 'Are you moving any plumbing or electrical?', 'What material are you thinking for countertops?', 'Do you have a rough budget range in mind?'].map(q => (
                  <div key={q} style={{ color: 'var(--color-ink)', fontSize: 13, display: 'flex', gap: 6 }}>
      ...
      {/* Step 2 */}
      <section id="estimates" style={{ padding: '90px 24px', background: 'var(--color-ink)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 60, alignItems: 'center' }}>
          <div style={{ background: 'color-mix(in srgb, var(--color-base) 3%, transparent)', border: '1px solid color-mix(in srgb, var(--color-base) 8%, transparent)', borderRadius: 16, padding: '28px' }}>
            <div style={{ color: 'var(--color-brand-light)', fontSize: 11, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 12 }}>Your AI estimate</div>
            <div style={{ fontFamily: 'monospace', fontSize: 40, fontWeight: 700, color: 'var(--color-base)', marginBottom: 4 }}>$18k–$22k</div>
            <div style={{ color: 'var(--color-line)', fontSize: 13, marginBottom: 20 }}>Based on 47 completed kitchen jobs in Bethesda, MD</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[
                ...
                <div key={item.label} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid color-mix(in srgb, var(--color-base) 5%, transparent)', paddingBottom: 8 }}>
                  <span style={{ color: 'var(--color-line)', fontSize: 13 }}>{item.label}</span>
                  <span style={{ color: 'var(--color-base)', fontFamily: 'monospace', fontSize: 13, fontWeight: 700 }}>{item.amount}</span>
                </div>
              ))}
            </div>
          </div>
          <div>
            <div style={{ fontFamily: 'monospace', fontSize: '6rem', fontWeight: 700, color: 'color-mix(in srgb, var(--color-base) 8%, transparent)', lineHeight: 1, marginBottom: 12 }}>02</div>
            <h2 style={{ color: 'var(--color-base)', fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 16 }}>
              Get a real cost breakdown
            </h2>
            <p style={{ color: 'var(--color-line)', fontSize: 16, lineHeight: 1.8, marginBottom: 20 }}>
            ...
            <p style={{ color: 'var(--color-line)', fontSize: 16, lineHeight: 1.8 }}>
      ...
      <section style={{ padding: '90px 24px', background: 'var(--color-base-alt)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 60, alignItems: 'center' }}>
          <div>
            <div style={{ fontFamily: 'monospace', fontSize: '6rem', fontWeight: 700, color: 'var(--color-line)', lineHeight: 1, marginBottom: 12 }}>03</div>
            <h2 style={{ color: 'var(--color-ink)', fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 16 }}>
      ...
      <section style={{ padding: '80px 24px', background: 'var(--color-ink)' }}>
        <div style={{ maxWidth: 800, margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ color: 'var(--color-base)', fontSize: 28, fontWeight: 800, letterSpacing: '-0.03em', marginBottom: 16 }}>
            After the match
          </h2>
